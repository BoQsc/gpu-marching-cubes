...
**File:** `modules/world_player_v2/features/combat/combat_system.gd`  
**Line:** 131
...
### Core Fix
- `modules/world_player_v2/features/combat/combat_system.gd` (line 131)

### Debug Logging (can be removed later)
- `modules/world_player_v2/features/inventory/hotbar.gd`
- `modules/world_player_v2/features/inventory/item_use_router.gd`
- `modules/world_player_v2/features/combat/combat_system.gd`
